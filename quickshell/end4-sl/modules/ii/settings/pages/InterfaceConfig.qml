...
ContentPage {
    ...
    ColumnLayout {
            ...
            GroupedList {
                ConfigComboBox {
                    ...
                    model: [{ displayName: Translation.tr("Default"), value: "" }]
                        .concat(SystemTheming.iconThemes.map(t => ({ displayName: t, value: t })))
            ...
            GroupedList {
                ...
                ConfigSpinBox {
                    ...
                    onValueChanged: {
                        ...
                        ifCursorSizeTimer.restart()
                    }
                    Timer {
                        id: ifCursorSizeTimer
                        interval: 500
                        repeat: false
                        onTriggered: SystemTheming.applyCursorTheme(SystemTheming.currentCursorTheme, ifCursorSizeSpin.value)
                    }
                }
            }
        }
        ...
        ContentSection {
            icon: "widgets"
            shape: MaterialShape.Shape.Arrow
            title: Translation.tr("Widget Theme (GTK)")
            ...
            GroupedList {
                ConfigComboBox {
                    ...
                    model: [{ displayName: Translation.tr("Default"), value: "" }]
                        .concat(SystemTheming.gtkThemes.map(t => ({ displayName: t, value: t })))
