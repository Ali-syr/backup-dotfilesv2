...
local menu        = "~/.config/ali/app_launcher.sh"
...
hl.bind(mainMod .. " + PERIOD", hl.dsp.exec_cmd("~/.config/ali/emoji_launcher.sh")) -- Emoji selector
hl.bind(mainMod .. " + V", hl.dsp.exec_cmd("~/.config/ali/clipboard_launcher.sh")) -- open clipboard
...
hl.bind(mainMod .. " + ALT", hl.dsp.window.move({ workspace = "special:magic" }))
