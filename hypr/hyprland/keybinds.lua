...
--local textEditor = textEditor or "gedit"
--local officeSoftware = officeSoftware or "libreoffice"
--local volumeMixer = volumeMixer or "pavucontrol"
--local settingsApp = settingsApp or "gnome-control-center"
--local taskManager ="htop"

--local qsScripts = "$HOME/.config/quickshell/$qsConfig/scripts"
--local hyprScripts = "$HOME/.config/hypr/hyprland/scripts"
--local qsIpcCall = "qs -c $qsConfig ipc call"
--local qsIsAlive = qsIpcCall .. " TEST_ALIVE"
--local qsConfig = "end4-sl"
--local qsIpcCall = "qs -c " .. qsConfig .. " ipc call"
...
-- ===================================================================
-- 1. SHELL & UI TOGGLES (Quickshell dengan Fallback Fuzzel/Wlogout)
-- ===================================================================
...
hl.bind("CTRL + SUPER + T", hl.dsp.exec_cmd("bash -c '" .. qsScripts .. "/colors/switchwall.sh --image \"$(find ~/Pictures/Wallpapers -type f | shuf -n 1)\"'"), { description = "Shell: Random wallpaper" })
-- ===================================================================
-- 2. HARDWARE & THEME CONTROLS
-- ===================================================================
...
--hl.bind("CTRL + SUPER + R", hl.dsp.exec_cmd("killall ydotool qs quickshell; quickshell -c $qsConfig &"), { description = "Shell: Restart widgets" })
--hl.bind("CTRL + SUPER + P", hl.dsp.global("quickshell:panelFamilyCycle"), { description = "Shell: Cycle panel family" })

-- ===================================================================
-- 3. UTILITIES (Screenshot, OCR, Record, Color Picker, Clipboard)
-- ===================================================================
...
--hl.bind("SUPER + SHIFT + S", hl.dsp.exec_cmd(qsIsAlive .. " || pidof slurp || grim -g \"$(slurp)\" - | wl-copy"))
...
hl.bind("SUPER + SHIFT + X", hl.dsp.exec_cmd(qsIsAlive .. " || pidof slurp || grim -g \"$(slurp)\" \"/tmp/ocr_image.png\" && tesseract \"/tmp/ocr_image.png\" stdout | wl-copy && rm \"/tmp/ocr_image.png\""))
...
hl.bind("SUPER + SHIFT + M", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SINK@ toggle"), { locked = true, description = "Media: Toggle mute" })
hl.bind("ALT + XF86AudioMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), { locked = true })
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), { locked = true })
--hl.bind("SUPER + ALT + M", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle"), { locked = true, description = "Media: Toggle mic" })
...
--hl.bind("ALT + F4", function() hl.exec_cmd("notify-send \"Wrong close keybind\" \"Super+Q to close.\" -a Hyprland") end, { non_consuming = true })
...
for i = 1, 2 do
    ...
    hl.bind("CTRL + SUPER + ALT + " .. keys[i], hl.dsp.focus({ workspace = prefix[i] == "r-" and "m-" or "m+" .. "1" }))
end
...
hl.bind("SUPER + Space", hl.dsp.exec_cmd("notify-send 'Test Notification' 'Hyprland notification test' -a 'Hyprland'"))
hl.bind("SUPER + ALT + Equal", hl.dsp.exec_cmd("notify-send 'Urgent notification' 'you carbite' -u critical -a 'Hyprland keybind'"))
